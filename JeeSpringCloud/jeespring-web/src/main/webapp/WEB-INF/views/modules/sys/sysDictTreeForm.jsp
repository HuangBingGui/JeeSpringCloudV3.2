...
<div class="wrapper">
    ...
    <div class="box box-main">
        ...
        <!-- 内容盒子身体 -->
        <div class="box-body">
            <form:form id="inputForm" modelAttribute="sysDictTree" action="${ctx}/sys/sysDictTree/save" method="post"
                ...
                <div class="content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6 form-group">
                            ...
                            <div class="col-sm-8">
                                <sys:treeselect id="parent" name="parent.id" value="${sysDict.parent.id}"
                                                labelName="parent.name" labelValue="${sysDict.parent.name}"
                                                title="父级编号" url="/sys/sysDictTree/treeData" extId="${sysDict.id}"
